...
abstract class BaseAgent
{
     ...
     */
    public function boot(JahEngine $engine, array $salkIdentity = []): void
    {
        $this->engine = $engine;
        $this->salkIdentity = $salkIdentity;
        $this->status = 'idle';
        $this->onBoot();
    }
    ...
    public function getSalkIdentity(): array
    {
        return $this->salkIdentity;
    }
}
